                ...
                <form id="form1" runat="server">
                    <div>
                        <div class="row">
                            <div class="col-md-4"></div>
                            <div class="col-md-8">
                                <img src="../Assets/Images/shopping_cart_64px.png"/>
                            </div>
                        </div>
                    </div>
                    <div class="mt-3">
                        <label for="" class="form-label">User Name</label>
                        <input type="email" placeholder="Your Email"  runat="server" autocomplete="off" class="form-control" id="UnameTb"/>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3 d-grid">
                        ...
                        <asp:Button Text="Login" runat="server" class="btn btn-success" ID="LoginBtn" OnClick="LoginBtn_Click" />
                    </div>
                </form>
            </div>
            <div class="col-md-4"></div>
