        ...
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col d-grid">
                    <asp:Button Text="Update" runat="server" class="btn btn-warning btn-block" ID="UpdateBtn" />
                </div>
                <div class="col d-grid">
                    <asp:Button Text="Save" runat="server" class="btn btn-success btn-block" ID="SaveBtn" OnClick="SaveBtn_Click" />
                </div>
                <div class="col d-grid">
                    <asp:Button Text="Delete" runat="server" class="btn btn-danger btn-block" ID="DeleteBtn" />
                </div>
            </div>
        </div>
        <div class="col-md-8">
            <asp:GridView ID="CategoriesList" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" Width="630px" OnSelectedIndexChanged="CategoriesList_SelectedIndexChanged" >
